...
var block = /** @class */ (function (_super) {
     ...
     * Called each frame.
     */
    block.prototype.onUpdate = function () {
    ...
    block.prototype.blockDispose = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("started");
                        sleep = function (second) { return new Promise(function (resolve) { return setTimeout(resolve, second); }); };
